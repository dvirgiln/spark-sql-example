import com.david.dataset.TransactionDatasetProcessor
import org.apache.spark.sql.SparkSession
import org.scalatest.{Matchers, WordSpec}

class TransactionDatasetProcessorSpec extends WordSpec with Matchers {
  ...
  "The TransactionStreamService" should {
    ...
    val processor = new TransactionDatasetProcessor(df, session)
    ...
    "should find the days with zero transactions" in {
